...
**Writing something a person has to approve?** A decision record, or a decision raised for someone to call, is addressed to whoever must say yes — not to whoever will implement it. An approval the reader cannot reason about is not an approval, and the damage concentrates in the closing ask, where every noun turns into a pointer only the author can resolve. See **Write for the person who has to act** in the full guide; it does not apply to text a machine reads and no human approves.
